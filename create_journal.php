            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="card shadow-lg">
                    <div class="card-header bg-success text-white">
                        <p class="h3">Create Journal Form</p>
                    </div>
                    <div class="card-body btn-light">
                        <form method="post" action="create_journal_action.php" enctype="multipart/form-data">
                            <div class="mb-2">
                                <input class="form-control" type="text" name="id" id="" placeholder="Id">
                            </div>
                            <div class="mb-2">
                                <input class="form-control" type="text" name="journal_name" id="" placeholder="Journal Name">
                            </div>
                            <div class="mb-2">
